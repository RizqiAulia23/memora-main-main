...
<head>
  ...
  <link rel="stylesheet" href="{{ assetv('css/gallery.css') }}">
</head>
<body>
  ...
  <div class="dash-layout">
    ...
    <main class="dash-main">
      ...
      <div class="dash-content">
        ...
        <!-- Grid -->
        <section class="reveal reveal-delay-1" aria-label="Photo gallery" data-gallery data-gsap-reveal>
  ...
  @vite('resources/js/gallery-animations.js')
  <script src="{{ assetv('js/main.js') }}"></script>
  <script src="{{ assetv('js/dashboard.js') }}"></script>
  <script src="{{ assetv('js/gallery.js') }}"></script>
</body>
</html>
