...
<head>
  ...
  <title>Too Many Requests - Memorify</title>
...
<body>
  <div class="err-cover">
    <div class="err-card">
      <div class="err-icon"><i class="fas fa-hand-peace"></i></div>
      <div class="err-code">429</div>
      <h1 class="err-title">Easy there, love</h1>
      <p class="err-text">You have made too many requests in a short time. Take a breath and try again in a moment.</p>
      <div class="err-nav">
