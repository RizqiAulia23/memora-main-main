...
<head>
  ...
  <title>Page Not Found - Memorify</title>
  ...
  <style>
    .err-page { min-height: 100vh; display: flex; align-items: center; justify-content: center; padding: 40px 24px;
      background: linear-gradient(160deg, #fff5f7 0%, #ffffff 45%, #ffe4ea 100%); }
...
<body>
  <main class="err-cover">
    <div class="err-card">
      <div class="err-icon"><i class="fas fa-compass"></i></div>
      <div class="err-code">404</div>
      <h1 class="err-title">This page wandered off</h1>
      <p class="err-text">The page you are looking for doesn't exist or has been moved. Let's get you back to your memories.</p>
      <div class="err-nav">
