...
<head>
  ...
  <title>Session Expired - Memorify</title>
...
<body>
  <div class="err-cover">
    <div class="err-card">
      <div class="err-icon"><i class="fas fa-hourglass-half"></i></div>
      <div class="err-code">419</div>
      <h1 class="err-title">Your session has expired</h1>
      <p class="err-text">It has been a while since you were active. Refresh the page and try again to keep your moments safe.</p>
      <div class="err-nav">
