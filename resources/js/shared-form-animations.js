...
function formReveal(isMobile) {
  const wrap = document.querySelector('.shm-form-wrap.reveal');
  if (!wrap) return;
...
createMotionModule('SharedForm', ({ matchMedia }) => {
  sharedFormEntrance();
