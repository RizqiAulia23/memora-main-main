---
name: debugging
description: Read logs, reproduce bug, identify root cause before fixing. Verify fix with tests.
---

# debugging

## Mission
Read logs, reproduce bug, identify root cause before fixing. Verify fix with tests.
